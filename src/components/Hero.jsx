                    ...
                    <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div className="sm:text-center lg:text-left">
                            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl">
                                <span className="block xl:inline">Aprender rápido en</span>{' '}
                                <span className="block text-teal-600 xl:inline">Frontend Academy</span>
                            </h1>
                            <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                Desarrollé esta web app para demostrar que con react, tailwind y firebase se puede crear «algo útil» en cuestión de horas (y porque no tengo espacio en drive)
                            </p>
                            <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                <div className="rounded-md shadow">
                                    <Link to='/curso/i8lRdbVKaggn1YXB0m1c'>
                                        <a
                                            href="#"
                                ...
                                <div className="mt-3 sm:mt-0 sm:ml-3">
                                    <a
                                        href="https://www.linkedin.com/in/manuelnelson7/"
